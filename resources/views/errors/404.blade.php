...
<link rel="stylesheet" href="/admin/css/main.css" type="text/css" media="screen, projection" /> <!-- main stylesheet -->
<link rel="stylesheet" type="text/css" media="all" href="/admin/css/tipsy.css" /> <!-- Tipsy implementation -->

<!--[if lt IE 9]>
    <link rel="stylesheet" type="text/css" href="css/ie8.css" />
<![endif]-->

<script type="text/javascript" src="/admin/scripts/jquery-1.7.2.min.js"></script> <!-- uiToTop implementation -->
<script type="text/javascript" src="/admin/scripts/custom-scripts.js"></script>
<script type="text/javascript" src="/admin/scripts/jquery.tipsy.js"></script> <!-- Tipsy -->
